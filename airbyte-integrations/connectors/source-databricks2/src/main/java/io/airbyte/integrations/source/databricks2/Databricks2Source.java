...
package io.airbyte.integrations.source.databricks2;
...
public class Databricks2Source extends AbstractJdbcSource<JDBCType> implements Source {

  private static final Logger LOGGER = LoggerFactory.getLogger(Databricks2Source.class);
  ...
  public static void main(final String[] args) throws Exception {
    final Source source = new Databricks2Source();
    LOGGER.info("starting source: {}", Databricks2Source.class);
    new IntegrationRunner(source).run(args);
    LOGGER.info("completed source: {}", Databricks2Source.class);
  }
