...
class Databricks2JdbcSourceAcceptanceTest extends JdbcSourceAcceptanceTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(Databricks2JdbcSourceAcceptanceTest.class);
  ...
  public String getDriverClass() {
    return Databricks2Source.DRIVER_CLASS;
  }
